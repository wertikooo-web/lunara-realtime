...
Дата аудита: 2026-07-13. Обновлено: 2026-07-19 (исходящие `audio.chunk` ограничены по умолчанию 4096 байтами PCM, чтобы полный JSON с запасом помещался в 8-КБ приёмный буфер ESP32).
