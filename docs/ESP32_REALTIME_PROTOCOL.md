...
Дата аудита: 2026-07-13. Обновлено: 2026-07-14 (Protocol V2 — переход ESP32 на единый режим 24/24, серверный ресемплинг входа, вынесенный из preload-обёртки в явный pipeline после ревью; см. changelog в конце файла).
