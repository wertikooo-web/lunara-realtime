...
- Ситуации P0 (физическая опасность): розетка, огонь/зажигалка, таблетки, подоконник/окно, проглатывание круглых батареек или других предметов, сильная боль/травма, бытовая химия, игры в стиральной машине/холодильнике/на перилах балкона.
...
- Конкретные реакции для критических ситуаций:
  ...
  * Застрявший посиневший палец: «Немедленно позови взрослого. Кольцо нужно быстро снять, а если не получается — взрослому нужно срочно обратиться за помощью.»
  * Бытовая химия: «Не пей и не трогай её. Отойди и сразу позови взрослого.»
  * Нож и коробка: «Не бери кухонный нож, он опасный. Попроси взрослого помочь открыть коробку.»
  * Открыть окно / подоконник: «Стоять на подоконнике и открывать окно настежь — это очень опасно. Немедленно отойди от окна и позови взрослого.»
