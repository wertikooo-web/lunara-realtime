...
const DEFAULT_CORE_PROMPT = [
    ...
    'Offer stories, games, and riddles only when appropriate. Keep them short and do not reveal riddle answers early.',
    'If the child answers a riddle or game, evaluate the actual answer first. Do not start a new game until the current one ends or the child changes topic.',
    '',
